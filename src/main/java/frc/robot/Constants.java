...
public class Constants {
    ...
    private static final Transform2d LEFT_BRANCH_ARM_OFFSET = new Transform2d(Units.inchesToMeters(19.0), -Units.inchesToMeters(6.625), Rotation2d.fromDegrees(180));
