...
public class Constants {
    ...
    public static final List<Pose2d> RED_BRANCH_POSES_SHIFTED_LEFT = List.of(RED_BRANCH_F2, RED_BRANCH_A1, RED_BRANCH_A2, RED_BRANCH_B1,
            RED_BRANCH_B2, RED_BRANCH_C1, RED_BRANCH_C2, RED_BRANCH_D1, RED_BRANCH_D2, RED_BRANCH_E1, RED_BRANCH_E2, RED_BRANCH_F1
    );

    public static final List<Pose2d> RED_BRANCH_POSES_SHIFTED_RIGHT = List.of(RED_BRANCH_A2, RED_BRANCH_B1, RED_BRANCH_B2, RED_BRANCH_C1,
            RED_BRANCH_C2, RED_BRANCH_D1, RED_BRANCH_D2, RED_BRANCH_E1, RED_BRANCH_E2, RED_BRANCH_F1, RED_BRANCH_F2, RED_BRANCH_A1
    );
    ...
    public static final List<Pose2d> BLUE_BRANCH_POSES_SHIFTED_LEFT = List.of(BLUE_BRANCH_F2, BLUE_BRANCH_A1, BLUE_BRANCH_A2, BLUE_BRANCH_B1,
            BLUE_BRANCH_B2, BLUE_BRANCH_C1, BLUE_BRANCH_C2, BLUE_BRANCH_D1, BLUE_BRANCH_D2, BLUE_BRANCH_E1, BLUE_BRANCH_E2, BLUE_BRANCH_F1
    );

    public static final List<Pose2d> BLUE_BRANCH_POSES_SHIFTED_RIGHT = List.of(BLUE_BRANCH_A2, BLUE_BRANCH_B1, BLUE_BRANCH_B2, BLUE_BRANCH_C1,
            BLUE_BRANCH_C2, BLUE_BRANCH_D1, BLUE_BRANCH_D2, BLUE_BRANCH_E1, BLUE_BRANCH_E2, BLUE_BRANCH_F1, BLUE_BRANCH_F2, BLUE_BRANCH_A1
    );
