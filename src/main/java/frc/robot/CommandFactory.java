...
public class CommandFactory {
    ...
    public Command goToL4() {
        return superStructure.goToPositions(Constants.ScoringPositions.CORAL_LEVEL_4_ELEVATOR_HEIGHT,
    ...
    public Command goToL3() {
        return superStructure.goToPositions(Constants.ScoringPositions.CORAL_LEVEL_3_ELEVATOR_HEIGHT,
    ...
    public Command goToL2() {
        return superStructure.goToPositions(Constants.ScoringPositions.CORAL_LEVEL_2_ELEVATOR_HEIGHT,
    ...
    public Command goToL1() {
        return superStructure.goToPositions(Constants.ScoringPositions.CORAL_LEVEL_1_ELEVATOR_HEIGHT,
    ...
    public Command goToNet() {
        return superStructure.goToPositions(Constants.ScoringPositions.ALGAE_NET_ELEVATOR_HEIGHT,
    ...
    public Command goToProcessor() {
        return superStructure.goToPositions(Constants.ScoringPositions.ALGAE_PROCESSOR_ELEVATOR_HEIGHT,
    ...
    public Command goToRemoveUpper() {
        return superStructure.goToPositions(Constants.ScoringPositions.REMOVE_ALGAE_UPPER_ELEVATOR_HEIGHT,
    ...
    public Command goToRemoveLower() {
        return superStructure.goToPositions(Constants.ScoringPositions.REMOVE_ALGAE_LOWER_ELEVATOR_HEIGHT,
