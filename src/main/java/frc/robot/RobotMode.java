...
public enum RobotMode {
    ...
    ALGAE_NET(Units.inchesToMeters(60.5), Units.degreesToRadians(105.0), Units.degreesToRadians(40.0), Gamepiece.ALGAE, true),
    ALGAE_NET_FIRING(Units.inchesToMeters(60.5), Units.degreesToRadians(90.0), Units.degreesToRadians(40.0), Gamepiece.ALGAE, true),
