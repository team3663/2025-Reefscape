...
public enum RobotMode {
    ...
    ALGAE_REMOVE_LOWER(Units.inchesToMeters(8.02), Units.degreesToRadians(31.28), Units.degreesToRadians(62.24), Gamepiece.ALGAE, false),
    ALGAE_REMOVE_UPPER(Units.inchesToMeters(24.52), Units.degreesToRadians(31.28), Units.degreesToRadians(62.24), Gamepiece.ALGAE, false),
