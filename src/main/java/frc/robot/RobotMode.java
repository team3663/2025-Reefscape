...
public enum RobotMode {
    ...
    CORAL_LEVEL_2(Units.inchesToMeters(6.287), Units.degreesToRadians(40.16601), Units.degreesToRadians(36.37695), Gamepiece.CORAL, true),
    CORAL_LEVEL_3(Units.inchesToMeters(22.787), Units.degreesToRadians(40.16601), Units.degreesToRadians(31.37695), Gamepiece.CORAL, true),
    ...
    CORAL_STATION_WITH_CORAL(ArmPositions.CORAL_STATION_ELEVATOR_HEIGHT_WITH_CORAL, ArmPositions.CORAL_STATION_SHOULDER_ANGLE_WITH_CORAL, ArmPositions.CORAL_STATION_WRIST_ANGLE_WITH_CORAL, Gamepiece.CORAL, false),
