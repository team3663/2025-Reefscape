...
public class C2025RobotFactory implements RobotFactory {
    ...
    private static final double MK4_2PLUS_REDUCTION = (50.0 / 16.0) * (17.0 / 27.0) * (45.0 / 15.0);
    private static final double MK4N_STEER_REDUCTION = 18.75;
    private static final double MK4N_STEER_INERTIA = 0.00001;
    ...
    private static final double FRAME_Y_LENGTH = Units.inchesToMeters(28.0);
