...
public class LimelightIO2 implements VisionIO {
    ...
    public LimelightIO2(String name, Transform3d transform, boolean isIgnored) {
    ...
    public void updateInputs(VisionInputs2 visionInputs, double currentYaw) {
        ...
        visionInputs.ta = LimelightHelpers.getTA(cameraName);
        visionInputs.txnc = LimelightHelpers.getTXNC(cameraName);
        visionInputs.tync = LimelightHelpers.getTYNC(cameraName);
    }
