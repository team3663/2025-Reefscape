...
public class AutoPaths {
        ...
        return drivetrain.goToPosition(() -> {
                ...
                () -> {
                    ...
                    if (elevatorHeight > ELEVATOR_EXTENDED_UPPER_HEIGHT) {
                        ...
                        return drivetrain.getConstants().maxLinearVelocity() * 0.6;
                    }
    ...
    private Command pickup(Pose2d blueAllianceTargetPose, Pose2d redAllianceTargetPose, RobotMode robotMode, Supplier<Pose2d> intermediatePoseSupplier) {
        ...
        return Commands.defer(() -> goToPosition(targetPoseHolder[0], intermediatePoseSupplier), Set.of(drivetrain))
                .withDeadline(Commands.sequence(
                        limitedArm(robotMode).alongWith(grabber.placeCoralL4()).until(() -> drivetrain.atPosition(targetPoseHolder[0].getTranslation(), PICKUP_LIMITED_ARM_DISTANCE)),
    ...
    public AutoRoutine twoCoralC1L4B1L4() {
        ...
        routine.active().onTrue(Commands.sequence(
                resetOdometry(Constants.BLUE_AUTO_RIGHT_STARTING_POSITION_6FT, Constants.RED_AUTO_RIGHT_STARTING_POSITION_6FT),
    ...
    public AutoRoutine twoCoralE2L4F2L4() {
        ...
        routine.active().onTrue(Commands.sequence(
                resetOdometry(Constants.BLUE_AUTO_LEFT_STARTING_POSITION_6FT, Constants.RED_AUTO_LEFT_STARTING_POSITION_6FT),
    ...
    public AutoRoutine oneCoralTwoAlgaeD2L4DEA() {
        ...
        routine.active().onTrue(Commands.sequence(
                ...
                placeNet(Constants.BLUE_NET_POSE_AUTO, Constants.RED_NET_POSE_AUTO, Constants.BLUE_CENTER_D.plus(REMOVE_ALGAE_OFFSET), Constants.RED_CENTER_D.plus(REMOVE_ALGAE_OFFSET)),
                ...
                placeNet(Constants.BLUE_NET_POSE_AUTO, Constants.RED_NET_POSE_AUTO, Constants.BLUE_CENTER_E.plus(REMOVE_ALGAE_OFFSET), Constants.RED_CENTER_E.plus(REMOVE_ALGAE_OFFSET)),
                goToPosition(
